...
class PASCALContext(data.Dataset):
    ...
    def __init__(self,
        ...
        self.cat_part = json.load(open(os.path.join(PROJECT_ROOT_DIR, 'datasets/db_info/pascal_part.json'), 'r'))
        ...
        self.normals = []
        if self.do_normals:
            with open(os.path.join(PROJECT_ROOT_DIR, 'datasets/db_info/nyu_classes.json')) as f:
                cls_nyu = json.load(f)
            with open(os.path.join(PROJECT_ROOT_DIR, 'datasets/db_info/context_classes.json')) as f:
