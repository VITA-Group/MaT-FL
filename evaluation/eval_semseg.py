...
def eval_semseg_predictions(database, save_dir, overfit=False, dataidx=None):
    ...
    if database.lower() == 'pascalcontext':
        ...
        has_bg = True
        gt_set = 'val'
        db = PASCALContext(split=gt_set, tasks=['semseg'], overfit=overfit, dataidxs=dataidx)
        ...
        has_bg = False
        gt_set = 'val'
        db = NYUD_MT_truncated(split=gt_set, tasks=['semseg'], overfit=overfit, dataidxs=dataidx)
