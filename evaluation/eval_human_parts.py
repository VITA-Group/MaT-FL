...
class HumanPartsMeter(object):
    def __init__(self, database):
        assert(database.lower() == 'pascalcontext')
...
def eval_human_parts_predictions(database, save_dir, overfit=False, dataidx=None):
    ...
    if database.lower() == 'pascalcontext':
        ...
        gt_set = 'val'
        db = PASCALContext(split=gt_set, tasks=['human_parts'], overfit=overfit, dataidxs=dataidx)
