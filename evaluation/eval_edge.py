...
from dataset.utils.mypath import MyPath, PROJECT_ROOT_DIR
...
def eval_edge_predictions(p, database, save_dir, dataidx=None):
    ...
    if database.lower() == 'pascalcontext':
        ...
        split = 'val'
        db = PASCALContext(split=split, tasks=['edge'], overfit=False, dataidxs=dataidx)
